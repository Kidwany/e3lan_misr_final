...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{adminUrl('/parent-location')}}">Locations</a></li>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="location" id="exampleInputEmail1" placeholder="Enter Location Name" value="{{$location->parentLocation_en->location}}">
